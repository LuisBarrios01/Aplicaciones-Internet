      ...
      <ul class="navbar-nav">
        ...
        <li class="nav-item<?php echo e($activePage == 'register' ? ' active' : ''); ?>">
          <a href="<?php echo e(route('register')); ?>" class="nav-link">
            <i class="material-icons">person_add</i> <?php echo e(__('Registrase')); ?>

          </a>
        </li>
        <li class="nav-item<?php echo e($activePage == 'login' ? ' active' : ''); ?>">
          <a href="<?php echo e(route('login')); ?>" class="nav-link">
            <i class="material-icons">fingerprint</i> <?php echo e(__('Iniciar sesión')); ?>
...
<!-- End Navbar --><?php /**PATH D:\BDA\Laravel\proyecto\resources\views/layouts/navbars/navs/guest.blade.php ENDPATH**/ ?>