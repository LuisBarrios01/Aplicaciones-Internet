...
<div class="container" style="height: auto;">
  <div class="row align-items-center">
    <div class="col-md-9 ml-auto mr-auto mb-3 text-center">
      <h3><?php echo e(__('Bienvenido a MERCOSUR')); ?></h3>
               <h4><?php echo e(__('Inicia sesión, o registrate para más')); ?> </h4>
    </div>
    <div class="col-lg-4 col-md-6 col-sm-8 ml-auto mr-auto">
      <form class="form" method="POST" action="<?php echo e(route('login')); ?>">
        ...
        <div class="card card-login card-hidden mb-3">
          ...
          <div class="card-body">
            <p class="card-description text-center"><?php echo e(__('Or Sign in with ')); ?> <?php echo e(__(' and the password ')); ?><strong>secret</strong> </p>
          ...
          <div class="card-footer justify-content-center">
            <button type="submit" class="btn btn-primary btn-link btn-lg"><?php echo e(__('Comenzar')); ?></button>
          </div>
        </div>
      </form>
      <div class="row">
...
<?php echo $__env->make('layouts.main', ['class' => 'off-canvas-sidebar', 'activePage' => 'login', 'title' => __('MERCOSUR 2021')], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\BDA\Laravel\proyecto\resources\views/auth/login.blade.php ENDPATH**/ ?>