            ...
            <form class="form" method="POST" action="<?php echo e(route('register')); ?>">
                ...
                <div class="card card-login card-hidden mb-3">
                    <div class="card-header card-header-primary text-center">
                        <h4 class="card-title"><strong><?php echo e(__('Registrarse')); ?></strong></h4>
                    ...
                    <div class="card-body ">
                        <p class="card-description text-center"><?php echo e(__('Ingresa tus datos')); ?></p>
                        ...
                        <div class="bmd-form-group<?php echo e($errors->has('password') ? ' has-danger' : ''); ?> mt-3">
                            <div class="input-group">
                                ...
                                <input type="password" name="password" id="password" class="form-control"
                                    placeholder="<?php echo e(__('Password...')); ?>" required autocomplete="new-password">
                            </div>
                        ...
                        <div
                            ...
                            <div class="input-group">
                                ...
                                <input type="password" name="password_confirmation" id="password_confirmation"
                                    class="form-control" placeholder="<?php echo e(__('Confirm Password...')); ?>" required autocomplete="new-password">
                            </div>
                    ...
                    <div class="card-footer justify-content-center">
                        <button type="submit"
                            class="btn btn-primary btn-link btn-lg"><?php echo e(__('Crear cuenta')); ?></button>
                    </div>
                </div>
            </form>
        </div>
...
<?php echo $__env->make('layouts.main', ['class' => 'off-canvas-sidebar', 'activePage' => 'register', 'title' => __('MERCOSUR 2021')], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\BDA\Laravel\proyecto\resources\views/auth/register.blade.php ENDPATH**/ ?>