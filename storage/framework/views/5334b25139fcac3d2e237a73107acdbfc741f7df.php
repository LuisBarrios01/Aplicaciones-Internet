...
<html lang="<?php echo e(str_replace('_', '-', app()->getLocale())); ?>">
    ...
    <title><?php echo e(__('Mercosur')); ?></title>
    ...
    <body class="<?php echo e($class ?? ''); ?>">
        ...
        <script src="<?php echo e(asset('/js/plugins/sweetalert2.js')); ?>"></script>
        <!-- Forms Validations Plugin -->
        <script src="<?php echo e(asset('/js/plugins/jquery.validate.min.js')); ?>"></script>
        <!-- Plugin for the Wizard, full documentation here: https://github.com/VinceG/twitter-bootstrap-wizard -->
        <script src="<?php echo e(asset('/js/plugins/jquery.bootstrap-wizard.js')); ?>"></script>
        <!--	Plugin for Select, full documentation here: http://silviomoreto.github.io/bootstrap-select -->
        <script src="<?php echo e(asset('/js/plugins/bootstrap-selectpicker.js')); ?>"></script>
        <!--  Plugin for the DateTimePicker, full documentation here: https://eonasdan.github.io/bootstrap-datetimepicker/ -->
        <script src="<?php echo e(asset('/js/plugins/bootstrap-datetimepicker.min.js')); ?>"></script>
        <!--  DataTables.net Plugin, full documentation here: https://datatables.net/  -->
        <script src="<?php echo e(asset('/js/plugins/jquery.dataTables.min.js')); ?>"></script>
        <!--	Plugin for Tags, full documentation here: https://github.com/bootstrap-tagsinput/bootstrap-tagsinputs  -->
        <script src="<?php echo e(asset('/js/plugins/bootstrap-tagsinput.js')); ?>"></script>
        <!-- Plugin for Fileupload, full documentation here: http://www.jasny.net/bootstrap/javascript/#fileinput -->
        <script src="<?php echo e(asset('/js/plugins/jasny-bootstrap.min.js')); ?>"></script>
        <!--  Full Calendar Plugin, full documentation here: https://github.com/fullcalendar/fullcalendar    -->
        <script src="<?php echo e(asset('/js/plugins/fullcalendar.min.js')); ?>"></script>
        <!-- Vector Map plugin, full documentation here: http://jvectormap.com/documentation/ -->
        <script src="<?php echo e(asset('/js/plugins/jquery-jvectormap.js')); ?>"></script>
        <!--  Plugin for the Sliders, full documentation here: http://refreshless.com/nouislider/ -->
        <script src="<?php echo e(asset('/js/plugins/nouislider.min.js')); ?>"></script>
        <!-- Include a polyfill for ES6 Promises (optional) for IE11, UC Browser and Android browser support SweetAlert -->
        <script src="https://cdnjs.cloudflare.com/ajax/libs/core-js/2.4.1/core.js"></script>
        <!-- Library for adding dinamically elements -->
        <script src="<?php echo e(asset('/js/plugins/arrive.min.js')); ?>"></script>
        ...
        <script src="<?php echo e(asset('/js/material-dashboard.js?v=2.1.1')); ?>" type="text/javascript"></script>
        
        <?php echo $__env->yieldPushContent('js'); ?>
    </body>
</html><?php /**PATH D:\BDA\Laravel\proyecto\resources\views/layouts/main.blade.php ENDPATH**/ ?>